...
const Program = () => {
  ...
  return (
    <section className=' ml-[82px] mr-[80px] text-white mt-[65px] '>
      <div className='flex  justify-between'>
        ...
        <button className=' hidden w-[336px] h-[123px] rounded-[20px] button flex items-center justify-center text-[25px] leading-[32.55px] font-bold font-main'>
          <h1 className='bg-primary w-[334px] h-[121px] rounded-[20px]   flex items-center justify-center'>
            Connect Wallet
          </h1>
        </button>
